...
try:
    ...
    from PySide6.QtCore import Qt, Signal, Slot, QSize, QPoint, QObject, QThread, QTimer
    ...
    from PySide6.QtWidgets import (
        ...
        QTreeWidget, QTreeWidgetItem, QMenu, QFileDialog, QMessageBox, QDockWidget, QTabWidget
    )
    QT_VERSION = 6
except ImportError:
    from PySide2 import QtWidgets, QtCore, QtGui
    from PySide2.QtCore import Qt, Signal, Slot, QSize, QPoint, QObject, QThread, QTimer
